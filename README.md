...
*Note: SELinux is set to `Enforcing` by default on RedHat. To allow Apache to connect to database through SELinux, do this `sudo setsebool -P httpd_can_network_connect_db 1`     
