...
## Windows/Linux/MAC 5.1.2-preview - 2017-11-20
Updated PECL release packages. Here is the list of updates:

### Fixed
- Support for non-UTF8 locales in Linux
...
### Limitations
- In Linux, only support locale set in PHP if it is done before the first connection
